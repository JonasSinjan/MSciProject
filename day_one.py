...
if __name__ == "__main__":
    ...
    start_dt = datetime(2019,6,21,10,58)#datetime(2019,6,21,10,57,50)
    end_dt = datetime(2019,6,21,10,58,50)

    start_csv, end_csv = which_csvs(soloA_bool, 1 ,start_dt, end_dt)
    print(start_csv, end_csv)
    all_files = [0]*(end_csv + 1 -start_csv)
    for index, i in enumerate(range(start_csv, end_csv + 1)):
        #print(index)
        if soloA_bool:
            if jonas:
