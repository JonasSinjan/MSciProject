...
if __name__ == "__main__":
    ...
    for num in [7]:
        ...
        start_dt = datetime(2019,6,24,10,7) + pd.Timedelta(days = 0, hours = 1, minutes = 59, seconds = 14, milliseconds = 283)# this is the start of the time we want to look at, #datetime(2019,6,21,10,57,50)
        end_dt = datetime(2019,6,24,10,58) + pd.Timedelta(days = 0, hours = 1, minutes = 59, seconds = 14, milliseconds = 283)# this is the end
        ...
        tmp = day_two(all_files, collist, soloA_bool, num, start_dt, end_dt, alt, sampling_freq = 1) #pass through the list containing the file paths
        b_noise.extend(tmp)
