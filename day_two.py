...
if __name__ == "__main__":
    ...
    start_dt = datetime(2019,6,24,10,56)# this is the start of the time we want to look at, #datetime(2019,6,21,10,57,50)
    end_dt = datetime(2019,6,24,11,20)# this is the end
    ...
    #print(all_files)
    day_two(all_files, collist, soloA_bool, num, start_dt, end_dt, sampling_freq = 50) #pass through the list containing the file paths
