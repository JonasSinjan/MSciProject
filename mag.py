...
if __name__ == "__main__":
    ...
    start_dt = datetime(2019,6,24,12,8)# this is the start of the time we want to look at, #datetime(2019,6,21,10,57,50)
    end_dt = datetime(2019,6,24,13,14)# this is the end
